...
class Fields {
  ...
  //   switch (type) {
  //     case 'input':
  //       return RegisterInputWidget((data) {
  ...
  //
  //     case 'upload':
  //       return RegisterAttachmentWidget((data) {
  //         userSelectedData = data;
  //       }, getTitle());
  //
  //     case 'date_picker':
  //       return RegisterDatePickerWidget((data) {
  //         userSelectedData = data.toString();
  //       }, getTitle());
  //
  //     case 'toggle':
  //       return RegisterToggleWidget((data) {
  //         userSelectedData = data;
  //       }, getTitle());
  //
  //     case 'textarea':
  //       return RegisterTextareaWidget((data) {
  //         userSelectedData = data;
  //       }, getTitle());
  //
  //     case 'dropdown':
  //       return RegisterDropDownWidget((data) {
  //         userSelectedData = data;
  //       }, getTitle(), options ?? []);
  //
  //     case 'checkbox':
  //       return RegisterCheckboxWidget((data) {
  //         userSelectedData = data;
  //         // print(userSelectedData.runtimeType);
  //       }, getTitle(), options ?? []);
  //
  //     case 'radio':
  //       return RegisterRadioWidget((data) {
  //         userSelectedData = data;
  //         // print(userSelectedData.runtimeType);
  //       }, getTitle(), options ?? []);
  //
...
class Options {
  ...
  String getTitle() {
    ...
    for (FieldTranslations element in fieldTranslations ?? []) {
      if (element.locale == Get.locale?.languageCode) {
        title = element.title ?? '';
      }
    }
